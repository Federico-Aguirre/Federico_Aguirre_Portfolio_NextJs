  ...
  return (
    ...
    >
      <motion.svg
        ...
        // CORRECCIÓN: initial para el contenedor
        initial={{ scale: 1 }}
      ...
      >
        <g>
          ...
          <motion.path
            ...
            animate={isActive ? { opacity: [0.6, 1, 0.6], y: [0, -5, 0] } : { opacity: 1, y: 0 }}
          ...
          <motion.path
            ...
            animate={isActive ? { opacity: [0.6, 1, 0.6], x: [0, 5, 0] } : { opacity: 1, x: 0 }}
            transition={waveTransition(0.5)}
          />
