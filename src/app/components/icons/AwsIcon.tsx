...
export const AwsIcon = ({ isActive = true, size = 32, style, ...props }: IconProps) => {
  ...
  // Si no está montado (SSR), devolvemos un div vacío con el tamaño para evitar saltos
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* PARTÍCULAS - Warning 2 arreglado con initial y opacity explícitos */}
      <AnimatePresence>
      ...
      >
        ...
        {/* LOGO AWS - Warning 1 arreglado: drop-shadow (con guion) y formato limpio */}
        <motion.g
