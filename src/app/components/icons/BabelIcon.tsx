  ...
  return (
    ...
    >
      <m.svg
        ...
        initial={{ scale: 1 }}
        animate={animateIcon ? { scale: [1, 1.05, 1] } : { scale: 1 }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        style={{ overflow: "visible" }}
      >
        <defs>
          <mask id={maskId}>
            <path d={babelPathOriginal} fill="white" />
          </mask>

          <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#f4d44b" />
            ...
            <stop offset="100%" stopColor="#f4d44b" />
          </linearGradient>
        </defs>
