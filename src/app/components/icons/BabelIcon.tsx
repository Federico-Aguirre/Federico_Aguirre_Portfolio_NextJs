...
export const BabelIcon = ({ isActive = true, size = 32, style, ...props }: IconProps) => {
  // El trazado exacto y original que me proporcionaste
  ...
  return (
    ...
    >
      <motion.svg
        ...
        // CORRECCIÓN 1: Añadir initial para el scale
        initial={{ scale: 1 }}
      ...
      >
        <defs>
          <mask id="babel-mask-original">
            <path d={babelPathOriginal} fill="white" />
          </mask>

          <linearGradient id="babel-scan-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#f4d44b" />
            
            <motion.stop 
              // CORRECCIÓN 2: El valor estático offset="0%" se quita y se pone en initial
              initial={{ offset: "0%" }} 
              stopColor="#fff5cc" 
              animate={isActive ? {
                offset: ["-100%", "200%"] 
        ...
        <rect 
          ...
          width="32" 
          height="32" 
          fill="url(#babel-scan-gradient)" 
          mask="url(#babel-mask-original)" 
        />
      </motion.svg>
    </div>
  );
