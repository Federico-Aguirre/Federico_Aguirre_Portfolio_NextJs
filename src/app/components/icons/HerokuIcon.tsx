...
export const HerokuIcon = ({ isActive = true, size = 30, style, ...props }: IconProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Agrupamos para aplicar la levitación al logo completo */}
        <motion.g
          animate={{ y: isActive ? [0, -4, 4, 0] : 0 }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        >
          {/* 1. Trazado / Contorno: Dibuja el logo cuando está activo */}
          <motion.path
            d={herokuPath}
            fill="none"
            stroke={brandPurple}
            strokeWidth="3" // Un grosor sutil para que luzca nítido
          ...
          {/* 2. Relleno Sólido: Aparece luego de completarse el trazado */}
          <motion.path
            d={herokuPath}
            fill={brandPurple}
            initial={{ opacity: 1 }}
