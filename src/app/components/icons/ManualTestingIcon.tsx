...
export const ManualTestingIcon = ({ isActive = false, size = 40, style, ...props }: IconProps) => {
  ...
  return (
    <div
      ...
      data-animate={animateIcon.toString()}
      style={{
        position: "relative",
        width: size,
        height: size,
    ...
    >
      <style>
        {`
          ...
          /* Animaciones activadas respetando preferencia de accesibilidad */
          div[data-animate="true"] .test-group {
            animation: inspectMotion 3.5s ease-in-out infinite;
          }

          div[data-animate="true"] .test-lens {
            animation: lensFocus 2.5s ease-in-out infinite;
          }

          div[data-animate="true"] .test-handle {
            animation: handleGlow 3.5s ease-in-out infinite;
          }

          div[data-animate="true"] .test-lines path {
