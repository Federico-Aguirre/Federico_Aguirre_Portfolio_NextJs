...
export const MantineIcon = ({ isActive = true, size = 32, style, ...props }: IconProps) => {
  ...
  useEffect(() => {
    ...
    const triggerRandomEvent = () => {
      // TIEMPO REDUCIDO A LA MITAD: Se dispara aleatoriamente entre 1 y 2 segundos
    ...
    >
      ...
      >
        ...
        <motion.path
          ...
          fill="#339AF0"
          initial={{ originX: 128, originY: 129 }}
        ...
        <motion.path
          ...
          fill="#FFFFFF"
          initial={{ originX: 128, originY: 129, scale: 1, rotate: 0 }}
          animate={
            event === 'latido' 
              ? { scale: [1, 1.15, 1] } 
              : event === 'wobble' 
