...
export const BootstrapIcon = ({ isActive = true, size = 100, style, ...props }: IconProps) => {
  return (
    <div
      style={{
        position: "relative",
    ...
    >
      <motion.svg
        key={isActive ? "bs-active" : "bs-inactive"}
        width="32px"
        height="32px"
        viewBox="0 0 256 256"
        xmlns="http://www.w3.org/2000/svg"
        style={{ overflow: "visible" }}
        // CORRECCIÓN 1: Definir estado inicial de escala
      ...
      >
        <g>
          ...
          <motion.path
            ...
            fill="#563D7C"
            // CORRECCIÓN 2: Definir color inicial
            initial={{ fill: "#563D7C" }}
            animate={isActive ? {
              fill: ["#563D7C", "#7952b3", "#563D7C"],
            } : { fill: "#563D7C" }}
          ...
          <motion.path
            ...
            fill="#FFFFFF"
            // CORRECCIÓN 3: Definir opacidad inicial
            initial={{ opacity: 1 }}
            animate={isActive ? { opacity: [1, 0.8, 1] } : { opacity: 1 }}
            transition={{ duration: 2, repeat: Infinity }}
          />
        </g>
      </motion.svg>
