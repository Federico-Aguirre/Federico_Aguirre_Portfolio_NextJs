...
export const BootstrapIcon = ({ isActive = true, size = 40, style, ...props }: IconProps) => {
  ...
  return (
    ...
    >
      <m.svg
        ...
        // Oculta de lectores de pantalla y quitar focus
        aria-hidden="true"
        focusable="false"
        width="100%"
        height="100%"
      ...
      >
        <g>
          ...
          <m.path
            ...
            initial={{ opacity: 1 }}
            // ACCESIBILIDAD
            animate={animateIcon ? { opacity: [1, 0.8, 1] } : { opacity: 1 }}
            transition={{ duration: 2, repeat: Infinity }}
          />
        </g>
      </m.svg>
