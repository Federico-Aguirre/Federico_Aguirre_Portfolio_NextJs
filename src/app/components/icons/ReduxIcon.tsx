    ...
    >
      ...
      <motion.path
        ...
        transition={isActive ? {
            ...
            duration: 0.2 // Desaparición rápida al desactivar
        }}
      />

      {/* ECO 2 (Expansión con delay) */}
      <motion.path
        d={logoPath}
        fill={reduxPurple}
        style={{ transformOrigin: "16px 16px" }}
        ...
        transition={isActive ? {
            ...
            duration: 0.2 // Desaparición rápida
        }}
      />
      ...
      <motion.path
        d={logoPath}
        style={{ transformOrigin: "16px 16px" }}
        initial={{ fill: white, rotate: 0 }}
        animate={{
          fill: isActive ? reduxPurple : white,
        ...
        transition={{
            ...
            rotate: isActive ? { 
                ...
                duration: 0.5, // Retorno suave a 0 grados
                ease: "easeOut"
            }
        }}
      />
