...
export const FirebaseIcon = ({ isActive = true, size = 40, style, ...props }: IconProps) => {
  ...
  return (
    ...
    >
      {/* CHISPAS / BRASAS */}
      {isMounted && animateIcon && clientEmbers.map((e) => (
        <m.div
      ...
      >
        ...
        <m.path
          ...
          fill="#ffc24a"
          initial={{ opacity: 0.8 }}
          animate={{ opacity: animateIcon ? [0.8, 1, 0.8] : 0.8 }}
        ...
        <m.path
          ...
          animate={{ y: animateIcon ? [0, -0.5, 0] : 0 }}
        ...
        <m.path
          ...
          animate={{ fill: animateIcon ? ["#fde068", "#ffeb99", "#fde068"] : "#fde068" }}
