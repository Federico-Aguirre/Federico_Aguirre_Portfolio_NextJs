...
export const PhpIcon = ({ isActive = false, size = 40, style, ...props }: IconProps) => {
  const phpBlueColor = "#8892BF";
  const glowShadow = `rgba(136, 146, 191, 0.8)`;
    ...
    >
      <style>
        {`
          ...
          div[data-active="true"] .php-active-circle {
            animation: phpPulseBg 2s ease-in-out infinite;
            transform-origin: 16px 16px;
          }
          div[data-active="true"] .php-active-letter-1 {
            animation: phpFloatY 1.5s ease-in-out infinite;
          }
          div[data-active="true"] .php-active-letter-2 {
            animation: phpFloatY 1.5s ease-in-out infinite 0.15s;
          }
          div[data-active="true"] .php-active-letter-3 {
            animation: phpFloatY 1.5s ease-in-out infinite 0.3s;
          }
      ...
      >
        <circle 
          ...
          r="14" 
          fill={phpBlueColor} 
          className="php-active-circle"
          style={{ transformOrigin: "16px 16px" }}
        />

        <g className="php-active-letter-1">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <g className="php-active-letter-2">
          <path
        ...
        <g className="php-active-letter-3">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
