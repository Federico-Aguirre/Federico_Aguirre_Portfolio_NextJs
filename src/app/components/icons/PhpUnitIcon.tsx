    ...
    >
      ...
      >
        ...
        <motion.rect
          ...
          width="1.97"
          height="1.88"
          initial={isActive ? { x: 22.72, y: 2.33 } : { x: 22.72, y: 2.33 }}
          animate={isActive ? {
        ...
        <motion.rect
          ...
          width="1.93"
          height="1.88"
          initial={isActive ? { x: 25.68, y: 7.62 } : { x: 25.68, y: 7.62 }}
          animate={isActive ? {
        ...
        <motion.rect
          ...
          width="1.93"
          height="1.88"
          initial={isActive ? { x: 31.56, y: 0 } : { x: 31.56, y: 0 }}
          animate={isActive ? {
        ...
        <motion.rect
          ...
          width="1.93"
          height="1.88"
          initial={isActive ? { x: 35.3, y: 2.4 } : { x: 35.3, y: 2.4 }}
          animate={isActive ? {
