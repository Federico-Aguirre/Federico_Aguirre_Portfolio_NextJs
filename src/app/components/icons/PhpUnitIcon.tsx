  ...
  return (
    ...
    >
      ...
      >
        ...
        <path fill="#3c9cd7" d="M3.06 0H1.81C.63 0 0 .76 0 2.24v7.27h2.08V6.13H3c1.72 0 2.45-1.2 2.45-3.19C5.45 1 4.62 0 4.62 0zm-.39 4.44h-.6V1.71h.61c.49 0 .73.37.73 1.29.01.98-.26 1.44-.74 1.44z" />
