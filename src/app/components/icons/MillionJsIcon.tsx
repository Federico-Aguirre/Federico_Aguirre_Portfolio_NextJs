...
export const MillionJsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="800px"
      height="800px"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop />
          <stop offset="1" stopColor="#3F3062" />
        </linearGradient>
        <radialGradient
          id="paint1_radial_1416_10"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(115.411 175.656) rotate(92.849) scale(11.206 24.9789)"
        >
          <stop stopColor="#845CE7" />
          <stop offset="1" stopColor="#AF73D8" />
        </radialGradient>
        <radialGradient
          id="paint2_radial_1416_10"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(115.172 117.749) rotate(92.7908) scale(23.0968 50.4359)"
        >
          <stop stopColor="#845CE7" />
          <stop offset="1" stopColor="#AF73D8" />
        </radialGradient>
        <radialGradient
          id="paint3_radial_1416_10"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
