...
* 🚀 **LCP (Largest Contentful Paint) Optimization:**
  * Eliminated invisible render-blocking states (`opacity: 0` initial state) and layout delay animations *Above the Fold* in the Hero section, ensuring instant SSR paint.
...
* ⚡ **Seamless SPA Experience:** Continuous navigation across *Home, Projects, About Me*, and *Contact* without page reloads.
